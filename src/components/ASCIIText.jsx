...
void main() {
    ...
    pos.x += sin(time + pos.y) * 0.005;
    pos.y += cos(time + pos.x) * 0.005;
...
class CanvAscii {
  ...
  async init() {
    try {
      await document.fonts.load(`600 200px "${this.textFontFamily}"`);
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #c4b5fd 0%, #7c3aed 50%, #3b82f6 100%);
