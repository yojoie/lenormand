...
const AccordionGallery = ({
  ...
  const handleClick = (i, e) => {
    if (i !== active) {
      e.preventDefault();
      setActive(i);
    } else if (onItemClickRef.current) {
      e.preventDefault();
      onItemClickRef.current(i);
    }
  };
  const handleKeyDown = (i, e) => {
    ...
    } else if (e.key === 'Enter' && i === active && onItemClickRef.current) {
      e.preventDefault();
      onItemClickRef.current(i);
    }
  };
        ...
        return (
          ...
          >
            <span className="ag-panel__frame">
              ...
              <span className="ag-panel__watermark-mask" aria-hidden="true" />
            </span>
            {showLabels && (
